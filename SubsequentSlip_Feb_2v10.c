...
#define MT 2	    //Material type: 1 - isotropic; 2 - cubic
...
//        clock_gettime(CLOCK_REALTIME, &tmstart);
	...
	for (i=0; i<ND; i++) {
        ...
        #pragma acc kernels 
        {
        #pragma acc loop  collapse(3) gang(512) /*gang vector(32)*/   /*gang worker(32)*/  private(k1,k2,k3,m,n,u,v,i,j,k,l,fk,nfreq,fk4,G)/*tile(2,1,2)*/ 
        #endif
	for(k1=0;k1<N1;k1++)  
        {
